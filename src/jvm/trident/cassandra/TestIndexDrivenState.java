 ...
 * @author jmeagher
 */
public class TestIndexDrivenState {
    public static void main(String[] args) throws Exception {
        ...
        opts.rowKeyIndex = new int[] {0};
        opts.columnNameIndex = new int[] {0};
        StateFactory cassandraStateFactory = CassandraState.transactional("localhost", opts);
